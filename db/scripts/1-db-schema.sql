...
-- -----------------------------------------------------
-- Placeholder table for view `ecommerce`.`purchase_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce`.`purchase_history` (`purchase_id` INT, `client_id` INT, `created_at` INT, `purchase_status_id` INT, `product_id` INT, `quantity` INT, `price` INT, `image` INT, `name` INT, `description` INT, `billing_info_id` INT, `address` INT, `email` INT, `tel` INT, `language_id` INT);
...
-- -----------------------------------------------------
-- View `ecommerce`.`purchase_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce`.`purchase_history`;
DROP VIEW IF EXISTS `ecommerce`.`purchase_history` ;
USE `ecommerce`;
CREATE  OR REPLACE VIEW `purchase_history` AS
SELECT purchase.purchase_id, purchase.client_id, purchase.created_at,purchase.purchase_status_id,product.product_id,php.quantity,product.price,product.image,phl.name,phl.description,billing_info.billing_info_id,billing_info.address,billing_info.email,billing_info.tel,phl.language_id
from purchase
